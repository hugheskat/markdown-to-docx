...
This will convert markdown files with basic markdown syntax to docx. The script is based on: 
...
- Images.
- Block code denoted by:

    ```
    code
    ```
  - Block code will be converted if it's indented by 4 spaces in the markdown.
